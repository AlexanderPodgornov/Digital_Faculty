list_numbers = [num for num in range(1, 1001) if '3' in str(num)]
print(list_numbers)

string = "Привет мир"
result_list = [chr for chr in string
               if chr != 'а' if chr != 'А'
               if chr != 'о' if chr != 'О'
               if chr != 'у' if chr != 'У'
               if chr != 'ы' if chr != 'Ы'
...
regions = {"1": "Республика Адыгея (Адыгея)", "2": "Республика Башкортостан", "3": "Республика Бурятия",
           ...
           "91": "Калининградская область", "40": "Калужская область", "41": "Камчатский край",
           ...
           "55": "Омская область", "56": "Оренбургская область", "57": "Орловская область", "58": "Пензенская область",
           ...
           "79": "Еврейская автономная область", "81": "Пермский край(старый)", "82": "Республика Крым", "83": "Ненецкий автономный округ",
           "86": "Ханты-Мансийский автономный округ - Югра", "87": "Чукотский автономный округ",
           "89": "Ямало-Ненецкий автономный округ", "92": "Республика Крым (город Севастополь)",
           "90": "Московская область (подмосковье)"}
dict = {number: regions.get(str(number)) for number in range(1, 100, 10)}
print(dict)
